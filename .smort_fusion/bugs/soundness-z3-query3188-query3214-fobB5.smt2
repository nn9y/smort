...
(assert (and (not (= (str.in_re (str.substr z_random1_3 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_4 0 (str.len (str.++ "B" "C")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_2 0 (str.len (str.++ "A" "B")))) (re.* re.allchar ))) (str.in_re (str.substr z_random0_29 0 (str.indexof z_random0_29 seed1_x (str.len seed0_x))) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random0_22 0 (str.indexof z_random0_22 (str.++ "C" "A") (str.len (str.++ "A" "B")))))) (re.* re.allchar ))))) (and (not (= (str.in_re (str.substr z_random0_27 (str.len (str.++ "A" "B")) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_3 (str.indexof z_random1_3 (str.++ "A" "C") (str.len seed0_x)) (str.len (str.++ "A" "C")))) (re.* re.allchar ) (str.to_re (str.substr z_random0_28 (str.len (str.++ "B" "C")) (str.len (str.++ "C" "A")))) (re.* re.allchar ))) (str.in_re (str.substr z_random0_29 (str.len seed0_x) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_0 (str.indexof z_random1_0 (str.++ "C" "A") (str.len seed0_x)) (str.len (str.++ "C" "A"))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random0_26 (str.len seed0_x) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random0_25 (str.len (str.++ "B" "C")) (str.len (str.++ "C" "A")))) (re.* re.allchar ) (str.to_re (str.substr z_random0_19 (str.len (str.++ "A" "B")) (str.len (str.++ "C" "A")))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_1 (str.indexof z_random1_1 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_4 (str.indexof z_random1_4 (str.++ "C" "A") (str.len (str.++ "B" "C"))) (str.len (str.++ "C" "A"))))) (re.* re.allchar ))))))))
(check-sat)
(exit)