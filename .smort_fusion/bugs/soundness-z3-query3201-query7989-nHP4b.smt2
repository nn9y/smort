...
(assert (and (not (= (str.in_re (str.substr z_random1_4 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random0_14 0 (str.indexof z_random0_14 seed1_x (str.len (str.++ "B" "C"))))) (re.* re.allchar ) (str.to_re (str.substr z_random1_5 0 (str.len (str.++ "C" "C")))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_3 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_0 0 (str.len (str.++ "C" "C"))))) (re.* re.allchar ))))) (and (not (= (str.in_re (str.substr z_random1_1 (str.indexof z_random1_1 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "C" (str.++ "A" (str.substr z_random0_18 (str.len seed0_x) (str.len (str.++ "C" "A")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random0_15 (str.len seed0_x) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_3 (str.indexof z_random1_3 (str.++ "A" "C") (str.len seed0_x)) (str.len (str.++ "A" "C"))))) (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_4 (str.indexof z_random1_4 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "C" (str.++ "A" (str.substr z_random1_5 (str.indexof z_random1_5 (str.++ "C" "B") (str.len (str.++ "C" "C"))) (str.len (str.++ "C" "B")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random0_13 (str.len seed0_x) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (re.inter re.allchar  (str.to_re "")) (re.* re.allchar ))))))))
(check-sat)
(exit)