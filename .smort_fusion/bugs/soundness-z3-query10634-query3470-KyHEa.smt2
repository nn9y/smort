...
(assert (and (not (= (str.in_re (str.substr z_random1_16 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) (str.to_re (str.substr z_random1_17 0 (str.len (str.++ "A" "B")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_15 0 (str.len (str.++ "C" "A")))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random1_13 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_18 0 (str.len (str.++ "C" "A"))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_15 (str.indexof z_random1_15 seed1_x (str.len (str.++ "C" "A"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_17 (str.indexof z_random1_17 (str.++ "A" "B") (str.len (str.++ "A" "B"))) (str.len (str.++ "A" "B"))))) (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ))) (str.in_re (str.substr z_random1_10 (str.indexof z_random1_10 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_16 (str.indexof z_random1_16 (str.++ "C" "A") (str.len seed0_x)) (str.len (str.++ "C" "A")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_18 (str.indexof z_random1_18 (str.++ "B" "B") (str.len (str.++ "C" "A"))) (str.len (str.++ "B" "B")))) (re.* re.allchar )))))))
(check-sat)
(exit)