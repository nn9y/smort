...
(assert (and (not (= (str.in_re (str.substr z_random1_25 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_27 0 (str.len (str.++ "A" "A")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_26 0 (str.len (str.++ "A" "B")))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_21 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_23 0 (str.len (str.++ "A" "B"))))) (re.* re.allchar ))))) (and (not (= (str.in_re (str.substr z_random1_15 (str.indexof z_random1_15 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_27 (str.indexof z_random1_27 (str.++ "A" "C") (str.len (str.++ "A" "A"))) (str.len (str.++ "A" "C"))))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_24 (str.indexof z_random1_24 seed1_x (str.len (str.++ "A" "A"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "B" (str.substr z_random1_26 (str.indexof z_random1_26 (str.++ "A" "C") (str.len (str.++ "A" "B"))) (str.len (str.++ "A" "C")))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_20 (str.indexof z_random1_20 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "B" (str.substr z_random1_22 (str.indexof z_random1_22 (str.++ "B" "C") (str.len (str.++ "A" "B"))) (str.len (str.++ "B" "C")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random1_21 (str.indexof z_random1_21 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "C" (str.++ "B" (str.substr z_random1_23 (str.indexof z_random1_23 (str.++ "A" "C") (str.len (str.++ "A" "B"))) (str.len (str.++ "A" "C")))))) (re.* re.allchar ))))))))
(check-sat)
(exit)