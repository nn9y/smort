...
(assert (and (and (= (str.substr z_random1_22 0 (str.len seed0_epsilon)) "") (= (str.substr z_random1_23 0 (str.len seed0_literal_2)) "") (= (str.substr z_random1_4 0 (str.len seed0_literal_3)) "") (or (= (str.substr z_random1_19 0 (str.len seed0_x_9)) (str.substr z_random1_2 0 (str.len seed0_epsilon))) (= seed0_x_9 (str.substr z_random1_8 0 (str.len seed0_literal_2))) (= (str.substr z_random0_14 0 (str.indexof z_random0_14 seed1_x (str.len seed0_x_9))) (str.substr z_random1_14 0 (str.len seed0_literal_3))) (= (str.substr z_random1_12 0 (str.len seed0_x_9)) (str.substr z_random1_18 0 (str.len seed0_sigmaStar_0)))) (= (str.substr z_random1_21 0 (str.len seed0_literal_10)) "\u{5c}\u{74}") (= (str.substr z_random1_9 0 (str.len seed0_x_11)) (str.++ (str.substr z_random1_13 0 (str.len seed0_x_9)) (str.substr z_random1_15 0 (str.len seed0_literal_10)))) (str.in_re (str.substr z_random1_20 0 (str.len seed0_x_11)) (re.++ (re.* re.allchar ) (re.++ (str.to_re "\u{5c}\u{3c}\u{53}\u{43}\u{52}\u{49}\u{50}\u{54}") (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_20 (str.indexof z_random1_20 seed1_x (str.len seed0_x_11)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_18 (str.indexof z_random1_18 (str.++ "A" "C") (str.len seed0_sigmaStar_0)) (str.len (str.++ "A" "C")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_23 (str.indexof z_random1_23 (str.++ "A" "A") (str.len seed0_literal_2)) (str.len (str.++ "A" "A")))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_19 (str.indexof z_random1_19 seed1_x (str.len seed0_x_9)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_22 (str.indexof z_random1_22 (str.++ "A" "A") (str.len seed0_epsilon)) (str.len (str.++ "A" "A"))))) (re.* re.allchar )))))))
(check-sat)
(exit)