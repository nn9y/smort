...
(assert (and (not (= (str.in_re (str.substr z_random1_19 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_20 0 (str.len (str.++ "C" "C"))))) (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ))) (str.in_re (str.substr z_random1_21 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_18 0 (str.len (str.++ "B" "C")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_23 0 (str.len (str.++ "C" "A")))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_22 (str.indexof z_random1_22 seed1_x (str.len (str.++ "C" "A"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_21 (str.indexof z_random1_21 (str.++ "A" "A") (str.len seed0_x)) (str.len (str.++ "A" "A")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_13 (str.indexof z_random1_13 (str.++ "C" "A") (str.len (str.++ "C" "C"))) (str.len (str.++ "C" "A")))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_23 (str.indexof z_random1_23 seed1_x (str.len (str.++ "C" "A"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_19 (str.indexof z_random1_19 (str.++ "C" "A") (str.len seed0_x)) (str.len (str.++ "C" "A"))))) (re.* re.allchar )))))))
(check-sat)
(exit)