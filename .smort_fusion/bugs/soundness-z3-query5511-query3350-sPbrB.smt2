...
(assert (and (and (not (= (str.in_re (str.substr z_random1_13 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_14 0 (str.len (str.++ "A" "C")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_17 0 (str.len (str.++ "B" "C")))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_12 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_8 0 (str.len (str.++ "B" "C"))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_18 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "C" (str.substr z_random1_15 0 (str.len (str.++ "A" "B")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random1_20 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "C" (str.++ "A" (str.substr z_random1_19 0 (str.len (str.++ "A" "B")))))) (re.* re.allchar )))))) (not (= (str.in_re (str.substr z_random1_20 (str.indexof z_random1_20 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_19 (str.indexof z_random1_19 (str.++ "C" "C") (str.len (str.++ "A" "B"))) (str.len (str.++ "C" "C"))))) (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ))) (str.in_re (str.substr z_random1_13 (str.indexof z_random1_13 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_15 (str.indexof z_random1_15 (str.++ "C" "A") (str.len (str.++ "A" "B"))) (str.len (str.++ "C" "A"))))) (re.* re.allchar )))))))
(check-sat)
(exit)