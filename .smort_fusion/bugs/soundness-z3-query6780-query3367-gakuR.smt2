...
(assert (and (and (not (= (str.in_re (str.substr z_random1_4 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_3 0 (str.len (str.++ "C" "B"))))) (re.* re.allchar ))) (str.in_re (str.substr z_random0_11 0 (str.indexof z_random0_11 seed1_x (str.len seed0_x))) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "C" (str.++ "A" (str.substr z_random1_0 0 (str.len (str.++ "A" "B")))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random0_10 0 (str.indexof z_random0_10 (str.++ "A" "B") (str.len seed0_x))) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random0_7 0 (str.indexof z_random0_7 (str.++ "A" "A") (str.len (str.++ "A" "C")))))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_2 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "A" (str.substr z_random1_1 0 (str.len (str.++ "C" "B")))))) (re.* re.allchar )))))) (not (= (str.in_re (str.substr z_random1_4 (str.indexof z_random1_4 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_3 (str.indexof z_random1_3 (str.++ "A" "A") (str.len (str.++ "C" "B"))) (str.len (str.++ "A" "A"))))) (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ))) (str.in_re (str.substr z_random1_1 (str.indexof z_random1_1 seed1_x (str.len (str.++ "C" "B"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_2 (str.indexof z_random1_2 (str.++ "A" "B") (str.len seed0_x)) (str.len (str.++ "A" "B"))))) (re.* re.allchar )))))))
(check-sat)
(exit)