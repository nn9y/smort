...
(assert (and (and (not (= (str.in_re (str.substr z_random1_25 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "B" (str.substr z_random1_15 0 (str.len (str.++ "B" "A")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random1_27 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_14 0 (str.len (str.++ "B" "B"))))) (re.* re.allchar ) (re.++ re.allchar  re.allchar ) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_26 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "B" (str.substr z_random1_20 0 (str.len (str.++ "B" "A")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random1_24 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_4 0 (str.len (str.++ "B" "B"))))) (re.* re.allchar ) (str.to_re "A") (re.* re.allchar )))))) (not (= (str.in_re (str.substr z_random1_26 (str.indexof z_random1_26 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_19 (str.indexof z_random1_19 (str.++ "A" "C") (str.len (str.++ "B" "A"))) (str.len (str.++ "A" "C"))))) (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ))) (str.in_re (str.substr z_random1_20 (str.indexof z_random1_20 seed1_x (str.len (str.++ "B" "A"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_27 (str.indexof z_random1_27 (str.++ "C" "A") (str.len seed0_x)) (str.len (str.++ "C" "A")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_23 (str.indexof z_random1_23 (str.++ "C" "B") (str.len seed0_x)) (str.len (str.++ "C" "B")))) (re.* re.allchar )))))))
(check-sat)
(exit)