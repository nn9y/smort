...
(assert (and (and (not (= (str.in_re (str.substr z_random0_19 0 (str.indexof z_random0_19 seed1_x (str.len seed0_x))) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "B" (str.substr z_random1_3 0 (str.len (str.++ "B" "A")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random1_0 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (re.++ (str.to_re (str.++ "B" (str.substr z_random1_7 0 (str.len (str.++ "B" "A"))))) re.allchar ) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_5 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_9 0 (str.len (str.++ "B" "A")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_4 0 (str.len (str.++ "C" "C")))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_6 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "A" (str.substr z_random1_8 0 (str.len (str.++ "C" "C")))))) (re.* re.allchar )))))) (and (not (= (str.in_re (str.substr z_random0_21 (str.len (str.++ "C" "C")) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "A" "C"))) (re.* re.allchar ))) (str.in_re (str.substr z_random0_15 (str.len (str.++ "B" "A")) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "B" (str.substr z_random1_9 (str.indexof z_random1_9 (str.++ "A" "C") (str.len (str.++ "B" "A"))) (str.len (str.++ "A" "C")))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random0_12 (str.len (str.++ "C" "C")) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_3 (str.indexof z_random1_3 (str.++ "B" "B") (str.len (str.++ "B" "A"))) (str.len (str.++ "B" "B"))))) (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ))) (str.in_re (str.substr z_random1_5 (str.indexof z_random1_5 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_7 (str.indexof z_random1_7 (str.++ "B" "A") (str.len (str.++ "B" "A"))) (str.len (str.++ "B" "A"))))) (re.* re.allchar ))))))))
(check-sat)
(exit)