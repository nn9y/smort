...
(assert (and (and (not (= (str.in_re (str.substr z_random1_26 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "B" (str.substr z_random1_7 0 (str.len (str.++ "B" "A")))))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_12 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "B" (str.substr z_random1_24 0 (str.len (str.++ "A" "B")))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_22 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_19 0 (str.len (str.++ "C" "C"))))) (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ))) (str.in_re (str.substr z_random1_25 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_16 0 (str.len (str.++ "C" "B"))))) (re.* re.allchar )))))) (not (= (str.in_re (str.substr z_random1_22 (str.indexof z_random1_22 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_20 (str.indexof z_random1_20 (str.++ "A" "A") (str.len seed0_x)) (str.len (str.++ "A" "A"))))) (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ))) (str.in_re (str.substr z_random1_26 (str.indexof z_random1_26 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_24 (str.indexof z_random1_24 (str.++ "A" "A") (str.len (str.++ "A" "B"))) (str.len (str.++ "A" "A"))))) (re.* re.allchar )))))))
(check-sat)
(exit)