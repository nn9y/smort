...
(assert (and (and (not (= (str.in_re (str.substr z_random1_14 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "C" (str.substr z_random1_26 0 (str.len (str.++ "B" "A")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random1_21 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_16 0 (str.len (str.++ "C" "B"))))) (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_24 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "B" (str.substr z_random1_23 0 (str.len (str.++ "C" "A")))))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_25 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "B" (str.substr z_random1_18 0 (str.len (str.++ "A" "B")))))) (re.* re.allchar )))))) (not (= (str.in_re (str.substr z_random1_25 (str.indexof z_random1_25 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_18 (str.indexof z_random1_18 (str.++ "A" "B") (str.len (str.++ "A" "B"))) (str.len (str.++ "A" "B"))))) (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ))) (str.in_re (str.substr z_random1_21 (str.indexof z_random1_21 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_26 (str.indexof z_random1_26 (str.++ "A" "A") (str.len (str.++ "B" "A"))) (str.len (str.++ "A" "A")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_22 (str.indexof z_random1_22 (str.++ "B" "C") (str.len seed0_x)) (str.len (str.++ "B" "C")))) (re.* re.allchar )))))))
(check-sat)
(exit)