...
(assert (and (and (not (= (str.in_re (str.substr z_random1_20 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_18 0 (str.len (str.++ "C" "C"))))) (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ))) (str.in_re (str.substr z_random1_22 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_21 0 (str.len (str.++ "C" "C"))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_19 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_23 0 (str.len (str.++ "C" "B"))))) (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ))) (str.in_re (str.substr z_random1_11 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_24 0 (str.len (str.++ "B" "B"))))) (re.* re.allchar )))))) (and (not (= (str.in_re (str.substr z_random1_15 (str.indexof z_random1_15 seed1_x (str.len (str.++ "B" "B"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "A" (str.substr z_random1_16 (str.indexof z_random1_16 (str.++ "B" "B") (str.len seed0_x)) (str.len (str.++ "B" "B")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random1_22 (str.indexof z_random1_22 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (re.inter re.allchar  (str.to_re "")) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_23 (str.indexof z_random1_23 seed1_x (str.len (str.++ "C" "B"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "C" (str.++ "B" (str.substr z_random1_24 (str.indexof z_random1_24 (str.++ "C" "C") (str.len (str.++ "B" "B"))) (str.len (str.++ "C" "C")))))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_17 (str.indexof z_random1_17 seed1_x (str.len (str.++ "C" "B"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "A" (str.substr z_random1_21 (str.indexof z_random1_21 (str.++ "B" "B") (str.len (str.++ "C" "C"))) (str.len (str.++ "B" "B")))))) (re.* re.allchar ))))))))
(check-sat)
(exit)