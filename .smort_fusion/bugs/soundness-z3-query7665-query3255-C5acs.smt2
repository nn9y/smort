...
(assert (and (and (not (= (str.in_re (str.substr z_random1_20 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_18 0 (str.len (str.++ "A" "B"))))) (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ))) (str.in_re (str.substr z_random1_14 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "A" (str.substr z_random1_12 0 (str.len (str.++ "B" "B")))))) (re.* re.allchar ))))) (str.in_re (str.substr z_random1_21 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "A" (str.substr z_random1_19 0 (str.len (str.++ "B" "B")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar )))) (not (= (str.in_re (str.substr z_random1_16 (str.indexof z_random1_16 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_12 (str.indexof z_random1_12 (str.++ "A" "A") (str.len (str.++ "B" "B"))) (str.len (str.++ "A" "A"))))) (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ))) (str.in_re (str.substr z_random1_15 (str.indexof z_random1_15 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_19 (str.indexof z_random1_19 (str.++ "A" "A") (str.len (str.++ "B" "B"))) (str.len (str.++ "A" "A")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_21 (str.indexof z_random1_21 (str.++ "A" "A") (str.len seed0_x)) (str.len (str.++ "A" "A")))) (re.* re.allchar )))))))
(check-sat)
(exit)