...
(assert (and (and (not (= (str.in_re (str.substr z_random1_13 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_18 0 (str.len (str.++ "C" "A")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_20 0 (str.len (str.++ "B" "B")))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_19 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_15 0 (str.len (str.++ "B" "B"))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_14 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "A" (str.substr z_random1_1 0 (str.len (str.++ "B" "B")))))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_22 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "B" (str.substr z_random1_21 0 (str.len (str.++ "B" "B")))))) (re.* re.allchar )))))) (and (not (= (str.in_re (str.substr z_random1_20 (str.indexof z_random1_20 seed1_x (str.len (str.++ "B" "B"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random0_1 (str.len seed0_x) (str.len (str.++ "B" "C")))) (re.* re.allchar ) (str.to_re (str.substr z_random0_10 (str.len (str.++ "B" "B")) (str.len (str.++ "A" "B")))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_19 (str.indexof z_random1_19 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "C" (str.substr z_random1_10 (str.indexof z_random1_10 (str.++ "A" "B") (str.len (str.++ "B" "B"))) (str.len (str.++ "A" "B")))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_22 (str.indexof z_random1_22 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_21 (str.indexof z_random1_21 (str.++ "A" "B") (str.len (str.++ "B" "B"))) (str.len (str.++ "A" "B"))))) (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ))) (str.in_re (str.substr z_random1_13 (str.indexof z_random1_13 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_18 (str.indexof z_random1_18 (str.++ "C" "A") (str.len (str.++ "C" "A"))) (str.len (str.++ "C" "A")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_0 (str.indexof z_random1_0 (str.++ "B" "B") (str.len seed0_x)) (str.len (str.++ "B" "B")))) (re.* re.allchar ))))))))
(check-sat)
(exit)