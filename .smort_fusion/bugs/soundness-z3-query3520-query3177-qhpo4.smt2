...
(assert (and (and (not (= (str.in_re (str.substr z_random1_19 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_13 0 (str.len (str.++ "B" "B")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_22 0 (str.len (str.++ "C" "C")))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_5 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_25 0 (str.len (str.++ "C" "C"))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_17 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_26 0 (str.len (str.++ "B" "B"))))) (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ))) (str.in_re (str.substr z_random1_6 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "C" (str.++ "B" (str.substr z_random1_27 0 (str.len (str.++ "B" "C")))))) (re.* re.allchar )))))) (not (= (str.in_re (str.substr z_random1_24 (str.indexof z_random1_24 seed1_x (str.len (str.++ "B" "C"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_11 (str.indexof z_random1_11 (str.++ "B" "B") (str.len (str.++ "B" "C"))) (str.len (str.++ "B" "B")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_26 (str.indexof z_random1_26 (str.++ "C" "C") (str.len (str.++ "B" "B"))) (str.len (str.++ "C" "C")))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_25 (str.indexof z_random1_25 seed1_x (str.len (str.++ "C" "C"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_27 (str.indexof z_random1_27 (str.++ "C" "C") (str.len (str.++ "B" "C"))) (str.len (str.++ "C" "C"))))) (re.* re.allchar )))))))
(check-sat)
(exit)