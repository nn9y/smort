...
(assert (and (and (not (= (str.in_re (str.substr z_random1_3 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "C" (str.substr z_random1_15 0 (str.len (str.++ "B" "A")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random1_9 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_2 0 (str.len (str.++ "C" "B"))))) (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_10 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "B" (str.substr z_random1_14 0 (str.len (str.++ "C" "A")))))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_13 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "B" (str.substr z_random1_5 0 (str.len (str.++ "A" "B")))))) (re.* re.allchar )))))) (not (= (str.in_re (str.substr z_random1_15 (str.indexof z_random1_15 seed1_x (str.len (str.++ "B" "A"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_14 (str.indexof z_random1_14 (str.++ "A" "B") (str.len (str.++ "C" "A"))) (str.len (str.++ "A" "B"))))) (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ))) (str.in_re (str.substr z_random1_11 (str.indexof z_random1_11 seed1_x (str.len (str.++ "C" "A"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_12 (str.indexof z_random1_12 (str.++ "A" "A") (str.len seed0_x)) (str.len (str.++ "A" "A")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_8 (str.indexof z_random1_8 (str.++ "B" "C") (str.len seed0_x)) (str.len (str.++ "B" "C")))) (re.* re.allchar )))))))
(check-sat)
(exit)