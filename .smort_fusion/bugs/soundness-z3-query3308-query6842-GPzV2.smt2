...
(assert (and (not (= (str.in_re (str.substr z_random1_22 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_19 0 (str.len (str.++ "A" "B"))))) (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ))) (str.in_re (str.substr z_random1_23 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_25 0 (str.len (str.++ "A" "A")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_24 0 (str.len (str.++ "B" "C")))) (re.* re.allchar ))))) (and (not (= (str.in_re (str.substr z_random1_20 (str.indexof z_random1_20 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "A" (str.substr z_random1_23 (str.indexof z_random1_23 (str.++ "B" "A") (str.len seed0_x)) (str.len (str.++ "B" "A")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random1_11 (str.indexof z_random1_11 seed1_x (str.len (str.++ "B" "C"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "B" (str.substr z_random1_16 (str.indexof z_random1_16 (str.++ "A" "B") (str.len seed0_x)) (str.len (str.++ "A" "B")))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_22 (str.indexof z_random1_22 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_24 (str.indexof z_random1_24 (str.++ "C" "A") (str.len (str.++ "B" "C"))) (str.len (str.++ "C" "A"))))) (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ))) (str.in_re (str.substr z_random1_18 (str.indexof z_random1_18 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_25 (str.indexof z_random1_25 (str.++ "A" "B") (str.len (str.++ "A" "A"))) (str.len (str.++ "A" "B"))))) (re.* re.allchar ))))))))
(check-sat)
(exit)