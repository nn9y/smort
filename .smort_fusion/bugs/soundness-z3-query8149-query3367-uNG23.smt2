...
(assert (and (and (not (= (str.in_re (str.substr z_random1_16 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_19 0 (str.len (str.++ "B" "A"))))) (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ))) (str.in_re (str.substr z_random1_22 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_20 0 (str.len (str.++ "A" "C"))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_11 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "C" (str.substr z_random1_21 0 (str.len (str.++ "C" "A")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random1_10 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "B" (str.substr z_random1_18 0 (str.len (str.++ "C" "A")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar )))))) (not (= (str.in_re (str.substr z_random1_21 (str.indexof z_random1_21 seed1_x (str.len (str.++ "C" "A"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_20 (str.indexof z_random1_20 (str.++ "A" "A") (str.len (str.++ "A" "C"))) (str.len (str.++ "A" "A"))))) (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ))) (str.in_re (str.substr z_random1_22 (str.indexof z_random1_22 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_19 (str.indexof z_random1_19 (str.++ "A" "B") (str.len (str.++ "B" "A"))) (str.len (str.++ "A" "B"))))) (re.* re.allchar )))))))
(check-sat)
(exit)