...
(assert (and (and (not (= (str.in_re (str.substr z_random1_22 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_14 0 (str.len (str.++ "C" "B"))))) (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ))) (str.in_re (str.substr z_random1_11 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "C" (str.substr z_random1_19 0 (str.len (str.++ "B" "A")))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_20 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "C" (str.substr z_random1_12 0 (str.len (str.++ "B" "A")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random1_21 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_18 0 (str.len (str.++ "C" "B"))))) (re.* re.allchar ) (str.to_re "A") (re.* re.allchar )))))) (not (= (str.in_re (str.substr z_random1_15 (str.indexof z_random1_15 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_14 (str.indexof z_random1_14 (str.++ "C" "C") (str.len (str.++ "C" "B"))) (str.len (str.++ "C" "C"))))) (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ))) (str.in_re (str.substr z_random1_17 (str.indexof z_random1_17 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_22 (str.indexof z_random1_22 (str.++ "C" "C") (str.len seed0_x)) (str.len (str.++ "C" "C"))))) (re.* re.allchar )))))))
(check-sat)
(exit)