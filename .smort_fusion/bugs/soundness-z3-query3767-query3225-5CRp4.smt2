...
(assert (and (and (not (= (str.in_re (str.substr z_random1_29 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_22 0 (str.len (str.++ "B" "A"))))) (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ))) (str.in_re (str.substr z_random1_18 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_27 0 (str.len (str.++ "A" "B")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_26 0 (str.len (str.++ "A" "A")))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_21 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "A" (str.substr z_random1_25 0 (str.len (str.++ "A" "A")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random1_28 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_20 0 (str.len (str.++ "A" "A"))))) (re.* re.allchar ) (str.to_re "A") (re.* re.allchar )))))) (not (= (str.in_re (str.substr z_random1_29 (str.indexof z_random1_29 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_20 (str.indexof z_random1_20 (str.++ "C" "B") (str.len (str.++ "A" "A"))) (str.len (str.++ "C" "B")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_23 (str.indexof z_random1_23 (str.++ "B" "B") (str.len (str.++ "A" "A"))) (str.len (str.++ "B" "B")))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_25 (str.indexof z_random1_25 seed1_x (str.len (str.++ "A" "A"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_28 (str.indexof z_random1_28 (str.++ "B" "B") (str.len seed0_x)) (str.len (str.++ "B" "B"))))) (re.* re.allchar )))))))
(check-sat)
(exit)