...
(assert (and (and (not (= (str.in_re (str.substr z_random1_28 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_24 0 (str.len (str.++ "B" "C")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_15 0 (str.len (str.++ "A" "B")))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_26 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "C" (str.substr z_random1_21 0 (str.len (str.++ "A" "B")))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_19 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_17 0 (str.len (str.++ "B" "C")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_22 0 (str.len (str.++ "A" "B")))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_27 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_14 0 (str.len (str.++ "A" "B"))))) (re.* re.allchar )))))) (not (= (str.in_re (str.substr z_random1_22 (str.indexof z_random1_22 seed1_x (str.len (str.++ "A" "B"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_24 (str.indexof z_random1_24 (str.++ "A" "C") (str.len (str.++ "B" "C"))) (str.len (str.++ "A" "C"))))) (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ))) (str.in_re (str.substr z_random1_28 (str.indexof z_random1_28 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_25 (str.indexof z_random1_25 (str.++ "C" "B") (str.len seed0_x)) (str.len (str.++ "C" "B"))))) (re.* re.allchar )))))))
(check-sat)
(exit)