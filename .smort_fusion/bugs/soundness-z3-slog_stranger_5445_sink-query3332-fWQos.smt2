...
(assert (and (str.in_re (str.substr z_random1_0 0 (str.len seed0_sigmaStar_2)) (re.++ (re.* re.allchar ) (re.++ (str.to_re "\u{2f}\u{65}\u{76}\u{69}\u{6c}") (re.* re.allchar )))) (and (not (= (str.in_re seed1_x (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "A" (str.substr z_random0_2 (str.len seed0_sigmaStar_2) (str.len (str.++ "B" "B")))))) (re.* re.allchar ))) (str.in_re seed1_x (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "A" (str.++ "A" "B")))) (re.* re.allchar ))))) (not (= (str.in_re seed1_x (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random0_3 (str.len seed0_sigmaStar_2) (str.len (str.++ "B" "A"))))) (re.* re.allchar ) (str.to_re "A") (re.* re.allchar ))) (str.in_re (str.substr z_random1_0 (str.indexof z_random1_0 seed1_x (str.len seed0_sigmaStar_2)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random0_0 (str.len seed0_sigmaStar_2) (str.len (str.++ "A" "B")))) (re.* re.allchar ) (str.to_re (str.substr z_random0_1 (str.len seed0_sigmaStar_2) (str.len (str.++ "A" "A")))) (re.* re.allchar ))))))))
(check-sat)
(exit)