...
(assert (and (and (not (= (str.in_re (str.substr z_random1_10 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_0 0 (str.len (str.++ "A" "B")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_5 0 (str.len (str.++ "C" "B")))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_8 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "B" (str.substr z_random1_4 0 (str.len (str.++ "C" "B")))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_6 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "A" (str.substr z_random1_12 0 (str.len (str.++ "B" "C")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random1_11 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_7 0 (str.len (str.++ "A" "B"))))) (re.* re.allchar ) (str.to_re "C") (re.* re.allchar )))))) (and (not (= (str.in_re (str.substr z_random1_12 (str.indexof z_random1_12 seed1_x (str.len (str.++ "B" "C"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random0_15 (str.len seed0_x) (str.len (str.++ "C" "B")))) (re.* re.allchar ) (str.to_re (str.substr z_random0_21 (str.len (str.++ "B" "C")) (str.len (str.++ "A" "C")))) (re.* re.allchar ))) (str.in_re (str.substr z_random0_17 (str.len seed0_x) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_4 (str.indexof z_random1_4 (str.++ "A" "C") (str.len (str.++ "C" "B"))) (str.len (str.++ "A" "C"))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_5 (str.indexof z_random1_5 seed1_x (str.len (str.++ "C" "B"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_9 (str.indexof z_random1_9 (str.++ "C" "C") (str.len (str.++ "B" "C"))) (str.len (str.++ "C" "C"))))) (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ))) (str.in_re (str.substr z_random1_10 (str.indexof z_random1_10 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "C" (str.substr z_random1_8 (str.indexof z_random1_8 (str.++ "C" "B") (str.len seed0_x)) (str.len (str.++ "C" "B")))))) (re.* re.allchar ))))))))
(check-sat)
(exit)