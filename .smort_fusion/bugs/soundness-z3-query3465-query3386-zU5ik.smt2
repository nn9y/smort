...
(assert (and (and (not (= (str.in_re (str.substr z_random1_15 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_12 0 (str.len (str.++ "C" "C"))))) (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ))) (str.in_re (str.substr z_random1_6 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_9 0 (str.len (str.++ "C" "C"))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_13 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.substr z_random1_11 0 (str.len (str.++ "C" "C")))) (re.* re.allchar ) (str.to_re (str.substr z_random1_10 0 (str.len (str.++ "C" "C")))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_14 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "C") (re.* re.allchar ) (str.to_re (str.++ "C" (str.substr z_random1_16 0 (str.len (str.++ "C" "C"))))) (re.* re.allchar )))))) (not (= (str.in_re (str.substr z_random1_12 (str.indexof z_random1_12 seed1_x (str.len (str.++ "C" "C"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_16 (str.indexof z_random1_16 (str.++ "A" "C") (str.len (str.++ "C" "C"))) (str.len (str.++ "A" "C"))))) (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ))) (str.in_re (str.substr z_random1_15 (str.indexof z_random1_15 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_13 (str.indexof z_random1_13 (str.++ "C" "B") (str.len seed0_x)) (str.len (str.++ "C" "B"))))) (re.* re.allchar )))))))
(check-sat)
(exit)