...
(assert (and (not (= (str.in_re (str.substr z_random1_17 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_16 0 (str.len (str.++ "A" "A"))))) (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ))) (str.in_re (str.substr z_random1_15 0 (str.len seed0_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "A" (str.substr z_random1_18 0 (str.len (str.++ "A" "B"))))) (re.* re.allchar ))))) (and (not (= (str.in_re (str.substr z_random1_8 (str.indexof z_random1_8 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re "B") (re.* re.allchar ) (str.to_re (str.++ "B" (str.substr z_random1_11 (str.indexof z_random1_11 (str.++ "A" "C") (str.len (str.++ "A" "A"))) (str.len (str.++ "A" "C"))))) (re.* re.allchar ))) (str.in_re (str.substr z_random1_18 (str.indexof z_random1_18 seed1_x (str.len (str.++ "A" "B"))) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "C" (str.++ "A" (str.substr z_random1_0 (str.indexof z_random1_0 (str.++ "A" "B") (str.len (str.++ "A" "A"))) (str.len (str.++ "A" "B")))))) (re.* re.allchar ))))) (not (= (str.in_re (str.substr z_random1_17 (str.indexof z_random1_17 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "B" (str.++ "C" (str.substr z_random1_13 (str.indexof z_random1_13 (str.++ "A" "C") (str.len seed0_x)) (str.len (str.++ "A" "C")))))) (re.* re.allchar ) re.allchar  (re.* re.allchar ))) (str.in_re (str.substr z_random1_15 (str.indexof z_random1_15 seed1_x (str.len seed0_x)) (str.len seed1_x)) (re.++ (re.* re.allchar ) re.allchar  (re.* re.allchar ) re.allchar  (re.* re.allchar ) (str.to_re (str.++ "A" (str.++ "B" (str.substr z_random1_14 (str.indexof z_random1_14 (str.++ "B" "A") (str.len seed0_x)) (str.len (str.++ "B" "A")))))) (re.* re.allchar ))))))))
(check-sat)
(exit)