...
(declare-fun |init_(ite main_#t~short4 1 0)| () Int)
(declare-fun |honda_(ite main_#t~short4 1 0)| () Int)
(declare-fun |ray_(ite main_#t~short4 1 0)| () Int)
(declare-fun |init_main_#t~mem5| () Int)
(declare-fun |honda_main_#t~mem5| () Int)
(declare-fun |ray_main_#t~mem5| () Int)
...
(assert
 (and
 (or
 (and (= |init_main_#t~mem2| |honda_main_#t~mem2|)
 (= |init_(select (select #memory_int main_~x~1.base) main_~x~1.offset)|
 |honda_(select (select #memory_int main_~x~1.base) main_~x~1.offset)|)
 (= |init_main_#t~mem1| |honda_main_#t~mem1|)
 (= |init_(ite main_#t~short4 1 0)| |honda_(ite main_#t~short4 1 0)|)
 (= |init_main_#t~mem5| |honda_main_#t~mem5|)
 ...
 (- 1)) (* (+ |honda_main_#t~mem1| |ray_main_#t~mem1|) 0)
 ...
 (* (+ |honda_(ite main_#t~short4 1 0)| |ray_(ite main_#t~short4 1 0)|) 0)
 (* (+ |honda_main_#t~mem5| |ray_main_#t~mem5|) 0)
 ...
 (*
 (+ |honda_(select (select #memory_int main_~x~1.base) main_~x~1.offset)|
 |ray_(select (select #memory_int main_~x~1.base) main_~x~1.offset)|) 1)
 ...
 (* (+ |honda_#NULL.base| |ray_#NULL.base|) 0) 
 (* |honda_main_#t~mem2| 0)
 (* |honda_(select (select #memory_int main_~x~1.base) main_~x~1.offset)| 1)
 (* |honda_main_#t~mem1| 0) 
 (* |honda_(ite main_#t~short4 1 0)| 0) 
 (* |honda_main_#t~mem5| 0) 
 (* |honda_main_#t~mem3| 0) 5) 0)
 ...
 (*
 (* |ray_(select (select #memory_int main_~x~1.base) main_~x~1.offset)|
 lambda) (- 1)) (* (* |ray_main_#t~mem1| lambda) 0)
 ...
 (* (* |ray_(ite main_#t~short4 1 0)| lambda) 0)
 (* (* |ray_main_#t~mem5| lambda) 0) 
 (* (* |ray_main_#t~mem3| lambda) 0) 
 (* (* ray_main_~x~1.offset lambda) 0) 
 (* (* |ray_#NULL.base| lambda) 0) 
 (* |ray_main_#t~mem2| 0)
 (* |ray_(select (select #memory_int main_~x~1.base) main_~x~1.offset)| 0)
 (* |ray_main_#t~mem1| 0) 
 (* |ray_(ite main_#t~short4 1 0)| 0) 
 (* |ray_main_#t~mem5| 0) 
 ...
 (*
 (* |ray_(select (select #memory_int main_~x~1.base) main_~x~1.offset)|
 lambda) 0) (* (* |ray_main_#t~mem1| lambda) 0)
 (* (* |ray_#NULL.offset| lambda) 0)
 (* (* |ray_(select old(#length) main_~x~1.base)| lambda) 0)
 (* (* |ray_main_#t~malloc0.offset| lambda) 0)
 (* (* |ray_(ite (select old(#valid) 0) 1 0)| lambda) 0)
 ...
 (* (* |ray_main_#t~malloc0.offset| lambda) 0)
 (* (* |ray_(ite (select old(#valid) 0) 1 0)| lambda) 0)
 (* (* |ray_(ite (select #valid main_~x~1.base) 1 0)| lambda) 1)
 (* (* |ray_(ite main_#t~short4 1 0)| lambda) 0)
 (* (* |ray_main_#t~mem5| lambda) 0) 
 (* (* |ray_main_#t~mem3| lambda) 0) 
 (* (* ray_main_~x~1.offset lambda) 0) 
